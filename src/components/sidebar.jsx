...
const closedMixin = (theme) => ({
  ...
  overflowX: 'hidden',
  width: 0,  // Set width to 0 for smaller screens
  [theme.breakpoints.up('sm')]: {
    width: `calc(${theme.spacing(7)} + 1px)`,  // Adjust width for larger screens
  },
});
...
export default function Sidebarmini() {
  ...
  const [open, setOpen] = React.useState(!isSmallScreen?true:false);
